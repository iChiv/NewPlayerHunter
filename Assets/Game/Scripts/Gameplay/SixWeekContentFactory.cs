...
namespace NewPlayerHunter.Gameplay
{
    internal static class SixWeekContentFactory
    {
        public static List<PlayerContentEntry> BuildPlayers()
        {
            ...
            {
                Player("player.rocket.rory", 0, 1, 3, "罗里·奎克", PlayerPosition.Forward, 88, 86, 76,
                ...
                Player("player.metronome.milo", 1, 2, 6, "米洛·陈", PlayerPosition.Midfielder, 81, 82, 91,
                ...
                Player("player.wall.walter", 2, 3, 4, "沃尔特·科瓦奇", PlayerPosition.Defender, 85, 73, 84,
                ...
                Player("player.turbo.tess", 3, 2, 5, "泰丝·奥科罗", PlayerPosition.Winger, 77, 94, 67,
                ...
                Player("player.gloves.gus", 4, 4, 3, "格斯·贝克", PlayerPosition.Goalkeeper, 79, 78, 88,
                ...
                Player("player.showboat.sonny", 5, 5, 2, "桑尼·布莱兹", PlayerPosition.Forward, 63, 69, 34,
                ...
                Player("player.utility.uma", 6, 3, 7, "乌玛·费尔南德斯", PlayerPosition.WingBack, 75, 87, 86,
                ...
                Player("player.cousin.carlo", 7, 1, 2, "卡洛·贝利尼", PlayerPosition.Midfielder, 42, 58, 51,
                ...
                Player("player.zodiac.luna", 8, 3, 2, "露娜·萨维奇", PlayerPosition.Winger, 74, 81, 59,
                ...
                Player("player.forms.felix", 9, 4, 5, "费利克斯·文书", PlayerPosition.Goalkeeper, 68, 72, 94,
                ...
                Player("player.rivet.rita", 10, 5, 6, "丽塔·哈达德", PlayerPosition.Defender, 82, 78, 92,
                    "位置感稳定的中后卫，处理危险球简单直接。",
                    "旧队长说她能让禁区通过安全检查。",
                ...
                Player("player.throwin.dino", 11, 4, 2, "迪诺·马尔凯蒂", PlayerPosition.Defender, 70, 83, 48,
                ...
                Player("player.spreadsheet.nova", 12, 5, 8, "诺瓦·伊万诺娃", PlayerPosition.Midfielder, 84, 76, 89,
                ...
                Player("player.bothfeet.echo", 13, 6, 8, "艾可·摩根", PlayerPosition.WingBack, 80, 90, 77,
                    "左右脚均衡、能覆盖两条边路的翼卫。",
                    "经纪材料称她是“两名球员共用一双球鞋”。",
                ...
                Player("player.thermos.vic", 14, 2, 3, "维克·哈珀", PlayerPosition.Forward, 78, 60, 95,
                ...
                Player("player.academy.perry", 15, 1, 5, "佩里·金", PlayerPosition.Forward, 67, 91, 43,
